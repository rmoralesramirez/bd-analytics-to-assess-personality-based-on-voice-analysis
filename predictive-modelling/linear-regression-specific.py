...
filter_col1_2019 = [
    col for col in all_features_2019 if col.startswith(principal_feature)
]
features_2019 = all_features_2019[filter_col1_2019].reset_index().drop("index", axis=1)

# 2020
filter_col1_2020 = [
    col for col in all_features_2020 if col.startswith(principal_feature)
]
...
# Dropping the last column to be the independent variable
df_2019 = df_2019.rename(columns={len(df_2019.columns) - 1: "personality"})
